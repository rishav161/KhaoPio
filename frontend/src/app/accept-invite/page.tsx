  ...
  return (
    <>
      <div className="mb-6 text-center text-zinc-800 dark:text-zinc-100">
        <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-50 dark:bg-brand-950/20 text-brand-500 mb-3">
        ...
        <div className="mt-3 inline-flex items-center gap-1.5 rounded-full bg-brand-50 dark:bg-brand-950/20 px-3 py-1 text-[10px] font-black uppercase tracking-wider text-brand-700 dark:text-brand-400 border border-brand-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {isManagerOrAdmin && (
            <div className="border-t border-zinc-200 dark:border-zinc-800 pt-4 mt-4 space-y-4">
              <h3 className="text-[10px] font-black uppercase tracking-wider text-brand-500">
                Dashboard Password
              </h3>
              <div>
                <label className="block text-[10px] font-black uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-1">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full cursor-pointer rounded-lg bg-brand-500 py-3 text-xs font-black uppercase tracking-wider text-white transition-all hover:bg-brand-600 active:scale-[0.98] disabled:opacity-50 shadow-md shadow-brand-100 dark:shadow-none"
          >
...
export default function AcceptInvite() {
  return (
    <div className="relative flex min-h-screen w-screen items-center justify-center overflow-hidden bg-zinc-100 dark:bg-zinc-950 px-4 font-sans text-zinc-900 dark:text-zinc-100 transition-colors duration-200">
      ...
      <div className="absolute top-1/4 left-1/4 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-brand-500/5 blur-[120px] pointer-events-none"></div>
      ...
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-8 shadow-2xl transition-all duration-300">
        ...
        {/* Top Glow Bar */}
        <div className="absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-brand-500 via-amber-500 to-yellow-400"></div>
